...
function processGroups(data) {
    ...
    if (result.errors.length === 0) {
        ...
        const faculty = {
            ...
            '3': 'Институт машиностроения, материалов и транспорта',
            ...
            '9': 'Высшая школа техносферной безопасности',
            '14': 'Институт ядерной энергетики (филиал) в г. Сосновый Бор',
            '20': 'Высшая школа биотехнологии и пищевых технологий',
            '21': 'Институт передовых производственных технологий',
            '22': 'Институт биомедицинских систем и биотехнологий'
        }
        const educationForm = {
            '1': 'Очная',
            '2': 'Очно-Заочная',
